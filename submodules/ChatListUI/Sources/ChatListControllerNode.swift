...
final class ChatListControllerNode: ASDisplayNode {
    ...
    init(context: AccountContext, groupId: PeerGroupId, previewing: Bool, controlsHistoryPreload: Bool, presentationData: PresentationData, controller: ChatListControllerImpl, circlesSettings: Circles? = nil) {
